...
const stats = [
  { value: `${useCases.length}`, label: "workflows documentés" },
  { value: "60%", label: "de temps gagné en moyenne" },
  { value: `${guides.length}`, label: "guides pratiques" },
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-base text-muted-foreground sm:text-xl max-w-2xl mx-auto leading-relaxed">
              {useCases.length} workflows IA documentés avec tutoriel pas-à-pas, stack technique
